...
namespace Game
{
    ...
    public class UserMainPagePanel : BaseCustomPanel
    {
        ...
        public override void Awake()
        {
            ...
            transform.FindObject<Button>("ChatBtn").onClick.AddListener(ChatBtnListener);
        }
        private void ChatBtnListener() 
        {
            GameCenter.Instance.ShowPanel<ChatPanel>((ui) =>
            {
                ui.SetChatData(mFriendAccount);
            });
        }
        ...
        private void EditorNotesBtnListener()
        {
            ...
            {
                ui.ShowContent("修改备注","确认", SureEditorNotesCallBack,20);
            });
        }
